...
tell application "System Events"
	tell application process "Safari"
		...
		tell window 1
			click button "¾ÏÈ£" of toolbar 1 of it
			-- õÚÊ¥ (Japanese), Add (English)
			repeat until (exists button "Ãß°¡" of group 1 of group 1 of it)
				if not (exists button "Ãß°¡" of group 1 of group 1 of it) then
	...
	tell application "System Events"
		tell application process "Safari"
			...
			tell window 1
				...
				click button "Ãß°¡" of group 1 of group 1 of it
				-- write fields
				-- High Sierra
